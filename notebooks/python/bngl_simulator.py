...
class BNGLSimulator:
    ...
    def __init__(self, bngl_file: str, param_values: Optional[Dict[str, float]] = None):
        ...
        # Also set parameters in RoadRunner simulator after creation
        # This is needed because setup_simulator() may not transfer all parameter values
        if param_values:
            for param_name, value in param_values.items():
                if param_name in self.parameters:
                    try:
                        ...
                        # Parameter might not be in RoadRunner sim, skip it
                        pass
