/*   
**   Example_SimpleSTAT_cvode.c
**	 
**   Cvode-Mex implementation of BioNetGen model 'Example_SimpleSTAT'.
**
...
**          -lsundials_nvecserial -lsundials_cvode -lm Example_SimpleSTAT_cvode.c
**
...
**        = Example_SimpleSTAT_cvode( timepoints, species_init, parameters )
**
**   timepoints      : column vector of time points returned by integrator.
**   parameters      : row vector of 26 parameters.
...
/* Problem Dimensions */
#define __N_PARAMETERS__   26
#define __N_EXPRESSIONS__  26
#define __N_OBSERVABLES__  6
#define __N_RATELAWS__     17
#define __N_SPECIES__      17
...
{
    NV_Ith_S(observables,0) = NV_Ith_S(species,13) +NV_Ith_S(species,15);
    NV_Ith_S(observables,1) = NV_Ith_S(species,14) +NV_Ith_S(species,16);
    NV_Ith_S(observables,2) = NV_Ith_S(species,13) +NV_Ith_S(species,15);
    NV_Ith_S(observables,3) = NV_Ith_S(species,14) +NV_Ith_S(species,16);
    NV_Ith_S(observables,4) = NV_Ith_S(species,13) +NV_Ith_S(species,15);
    NV_Ith_S(observables,5) = NV_Ith_S(species,14) +NV_Ith_S(species,16);
...
{  
    ...
    NV_Ith_S(ratelaws,1) = NV_Ith_S(expressions,23)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,2) = NV_Ith_S(expressions,1)*NV_Ith_S(species,9);
    NV_Ith_S(ratelaws,3) = NV_Ith_S(expressions,2)*NV_Ith_S(species,9)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,4) = NV_Ith_S(expressions,3)*NV_Ith_S(species,10);
    NV_Ith_S(ratelaws,5) = NV_Ith_S(expressions,4)*NV_Ith_S(species,10)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,6) = NV_Ith_S(expressions,5)*NV_Ith_S(species,11);
    NV_Ith_S(ratelaws,7) = NV_Ith_S(expressions,8)*NV_Ith_S(species,11)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,8) = NV_Ith_S(expressions,6)*NV_Ith_S(species,11)*NV_Ith_S(species,7);
    NV_Ith_S(ratelaws,9) = NV_Ith_S(expressions,7)*NV_Ith_S(species,11)*NV_Ith_S(species,8);
    NV_Ith_S(ratelaws,10) = NV_Ith_S(expressions,9)*NV_Ith_S(species,12);
    NV_Ith_S(ratelaws,11) = NV_Ith_S(expressions,10)*NV_Ith_S(species,13);
    NV_Ith_S(ratelaws,12) = NV_Ith_S(expressions,11)*NV_Ith_S(species,14);
    NV_Ith_S(ratelaws,13) = NV_Ith_S(expressions,12)*NV_Ith_S(species,5)*NV_Ith_S(species,15);
    NV_Ith_S(ratelaws,14) = NV_Ith_S(expressions,13)*NV_Ith_S(species,6)*NV_Ith_S(species,16);
    NV_Ith_S(ratelaws,15) = NV_Ith_S(expressions,14)*NV_Ith_S(species,15);
    NV_Ith_S(ratelaws,16) = NV_Ith_S(expressions,15)*NV_Ith_S(species,16);
...
calc_species_deriv ( realtype time, N_Vector species, N_Vector Dspecies, void * f_data )
{
    ...
    NV_Ith_S(Dspecies,0) = -NV_Ith_S(ratelaws,0) +NV_Ith_S(ratelaws,2);
    NV_Ith_S(Dspecies,1) = -NV_Ith_S(ratelaws,0) +NV_Ith_S(ratelaws,2);
    NV_Ith_S(Dspecies,2) = -NV_Ith_S(ratelaws,3) +NV_Ith_S(ratelaws,4);
    NV_Ith_S(Dspecies,3) = -NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,6);
    NV_Ith_S(Dspecies,4) = -NV_Ith_S(ratelaws,1) -NV_Ith_S(ratelaws,7) +NV_Ith_S(ratelaws,10) +NV_Ith_S(ratelaws,15) +NV_Ith_S(ratelaws,16);
    NV_Ith_S(Dspecies,5) = 0.0;
    NV_Ith_S(Dspecies,6) = 0.0;
    NV_Ith_S(Dspecies,7) = -NV_Ith_S(ratelaws,8) +NV_Ith_S(ratelaws,13);
    NV_Ith_S(Dspecies,8) = -NV_Ith_S(ratelaws,9) +NV_Ith_S(ratelaws,14);
    NV_Ith_S(Dspecies,9) = NV_Ith_S(ratelaws,0) -NV_Ith_S(ratelaws,2) -NV_Ith_S(ratelaws,3) +NV_Ith_S(ratelaws,4);
    NV_Ith_S(Dspecies,10) = NV_Ith_S(ratelaws,3) -NV_Ith_S(ratelaws,4) -NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,6);
    NV_Ith_S(Dspecies,11) = NV_Ith_S(ratelaws,5) -NV_Ith_S(ratelaws,6) -NV_Ith_S(ratelaws,7) -NV_Ith_S(ratelaws,8) -NV_Ith_S(ratelaws,9) +NV_Ith_S(ratelaws,10) +NV_Ith_S(ratelaws,11) +NV_Ith_S(ratelaws,12);
    NV_Ith_S(Dspecies,12) = NV_Ith_S(ratelaws,7) -NV_Ith_S(ratelaws,10);
    NV_Ith_S(Dspecies,13) = NV_Ith_S(ratelaws,8) -NV_Ith_S(ratelaws,11);
    NV_Ith_S(Dspecies,14) = NV_Ith_S(ratelaws,9) -NV_Ith_S(ratelaws,12);
    NV_Ith_S(Dspecies,15) = NV_Ith_S(ratelaws,11) -NV_Ith_S(ratelaws,13);
    NV_Ith_S(Dspecies,16) = NV_Ith_S(ratelaws,12) -NV_Ith_S(ratelaws,14);
...
void mexFunction( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
    ...
    {  mexErrMsgTxt("SPECIES_INIT must be a row vector with 17 elements.");  } 

    /* make sure params has correct dimensions */
    if ( (mxGetM(prhs[2]) != 1)  ||  (mxGetN(prhs[2]) != __N_PARAMETERS__) )
    {  mexErrMsgTxt("PARAMS must be a column vector with 26 elements.");  }
