...
% Simulate and auto generate plot (Uses ode15s)
% [err, timepoints, species_out, observables_out] = Example_SimpleSTAT( timepoints, species_init, parameters, 0);

% Custom Plot (uses ode15s)
species_init(01) = 10;  % IL10(il10r1) IL10_0
[err, timepoints, species_out, observables_out] = Example_SimpleSTAT( timepoints, species_init, parameters, 1);
